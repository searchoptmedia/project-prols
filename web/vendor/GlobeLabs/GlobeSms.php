...
namespace Propelrr\CoreBundle\APIutils\GlobeLabs;
...
class GlobeSms extends GlobeClient
{
     ...
     * @return array
     */
    public function sendMessage($number = null, $message = null, $passphrase, $appId, $appSecret, $bodyOnly = true)
    {
        /*if ($accesstoken) {
        ...
        $url = 'https://devapi.globelabs.com.ph/smsmessaging/v1/outbound/6000/requests?app_id='.$appId.'&app_secret='.$appSecret.'';
        $postFields = array(
            'message' => $this->message,
            'address' => $this->recepient,
            'senderAddress' => $this->address,
        ...
        return $this->getReturn($response, false);
    }
}
