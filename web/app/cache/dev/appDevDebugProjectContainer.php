...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'security.user.provider.concrete.prols_user' => 'getSecurity_User_Provider_Concrete_ProlsUserService',
            ...
            'swiftmailer.mailer.dev_mailer' => 'getSwiftmailer_Mailer_DevMailerService',
            'swiftmailer.mailer.dev_mailer.plugin.messagelogger' => 'getSwiftmailer_Mailer_DevMailer_Plugin_MessageloggerService',
            'swiftmailer.mailer.dev_mailer.transport' => 'getSwiftmailer_Mailer_DevMailer_TransportService',
        ...
        $this->aliases = array(
            ...
            'mailer' => 'swiftmailer.mailer.dev_mailer',
            'sensio.distribution.webconfigurator' => 'sensio_distribution.webconfigurator',
            'session.storage' => 'session.storage.native',
            'swiftmailer.mailer' => 'swiftmailer.mailer.dev_mailer',
            'swiftmailer.plugin.messagelogger' => 'swiftmailer.mailer.dev_mailer.plugin.messagelogger',
            'swiftmailer.transport' => 'swiftmailer.mailer.dev_mailer.transport',
        );
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'PropelBundle', ($this->targetDirs[2].'/Resources/PropelBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'PropelBundle', ($this->targetDirs[3].'\\vendor\\propel\\propel-bundle\\Propel\\PropelBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SmsBundle', ($this->targetDirs[2].'/Resources/SmsBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SmsBundle', ($this->targetDirs[3].'\\src\\SmsBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \CoreBundle\AuthenticationHandler\LoginHandler A CoreBundle\AuthenticationHandler\LoginHandler instance.
     */
    protected function getLoginHandlerService()
    {
        return $this->services['login_handler'] = new \CoreBundle\AuthenticationHandler\LoginHandler($this->get('router'), $this->get('security.context'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \CoreBundle\AuthenticationHandler\LogoutHandler A CoreBundle\AuthenticationHandler\LogoutHandler instance.
     */
    protected function getLogoutHandlerService()
    {
        return $this->services['logout_handler'] = new \CoreBundle\AuthenticationHandler\LogoutHandler($this->get('router'), $this->get('security.context'));
    }
    ...
    {
        return $this->services['propel.configuration'] = new \PropelConfiguration(array('datasources' => array('prols' => array('adapter' => 'mysql', 'connection' => array('dsn' => 'mysql:host=127.0.0.1;dbname=prols;charset=UTF8', 'user' => 'root', 'classname' => 'DebugPDO', 'options' => array(), 'attributes' => array(), 'settings' => array(), 'model_paths' => array(0 => 'src/', 1 => 'vendor/'))), 'default' => array('adapter' => 'mysql', 'connection' => array('dsn' => 'mysql:host=127.0.0.1;dbname=prols;charset=UTF8', 'user' => 'root', 'classname' => 'DebugPDO', 'options' => array(), 'attributes' => array(), 'settings' => array(), 'model_paths' => array(0 => 'src/', 1 => 'vendor/'))))));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => false, 2 => 1)), 'CoreBundle\\Model\\EmpAcc' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $k->add($j, array(0 => 'ROLE_ANALYST'), NULL);

        $l = new \Symfony\Component\Security\Http\HttpUtils($d, $d);

        $m = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $l, $this->get('logout_handler'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($k, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.chain_provider'), 1 => $this->get('security.user.provider.concrete.in_memory'), 2 => $this->get('security.user.provider.concrete.prols_user')), 'secured_area', $a, $c), 2 => $m, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $l, 'secured_area', new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler($this->get('login_handler'), array('login_path' => 'login', 'default_target_path' => '/', 'use_referer' => true, 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path'), 'secured_area'), $n, array('check_path' => '_security_check', 'use_forward' => true, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '579837b1cb2253.29874392', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $k, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $l, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $l, 'login', true), 'error403', NULL, $a));
    }
    ...
    {
        return $this->services['session.storage.native'] = new \Symfony\Component\HttpFoundation\Session\Storage\NativeSessionStorage(array('cookie_lifetime' => 18000, 'gc_maxlifetime' => 3600, 'gc_probability' => 0, 'gc_divisor' => 1), NULL, $this->get('session.storage.metadata_bag'));
    }
    ...
    /**
     * Gets the 'swiftmailer.mailer.dev_mailer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSwiftmailer_Mailer_DevMailerService()
    {
        return $this->services['swiftmailer.mailer.dev_mailer'] = new \Swift_Mailer($this->get('swiftmailer.mailer.dev_mailer.transport'));
    }

    /**
     * Gets the 'swiftmailer.mailer.dev_mailer.plugin.messagelogger' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSwiftmailer_Mailer_DevMailer_Plugin_MessageloggerService()
    {
        return $this->services['swiftmailer.mailer.dev_mailer.plugin.messagelogger'] = new \Swift_Plugins_MessageLogger();
    }

    /**
     * Gets the 'swiftmailer.mailer.dev_mailer.transport' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSwiftmailer_Mailer_DevMailer_TransportService()
    {
        ...
        $this->services['swiftmailer.mailer.dev_mailer.transport'] = $instance = new \Swift_Transport_EsmtpTransport(new \Swift_Transport_StreamBuffer(new \Swift_StreamFilters_StringReplacementFilterFactory()), array(0 => $a), new \Swift_Events_SimpleEventDispatcher());
        ...
        $instance->registerPlugin($this->get('swiftmailer.mailer.dev_mailer.plugin.messagelogger'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\SmsBundle/Resources/views'), 'Sms');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('65d05243b2553594b4809b4ed5e75bda13de3d24');
    }
    ...
    {
        return $this->services['security.user.provider.concrete.chain_provider'] = new \Symfony\Component\Security\Core\User\ChainUserProvider(array(0 => $this->get('security.user.provider.concrete.in_memory'), 1 => $this->get('security.user.provider.concrete.prols_user')));
    }
    ...
    protected function getSecurity_User_Provider_Concrete_InMemoryService()
    {
        ...
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('superadmin', 'f3b79a6e26ffd1bdf55079739d169e37f06c9bdbbc10e0a09e89a1113963873a03f962a0bdeec23e56461780631f011b466ab1882d3e5330846c7f19442cfdc6', array(0 => 'ROLE_ADMIN')));

        return $instance;
    }

    /**
     * Gets the 'security.user.provider.concrete.prols_user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_User_Provider_Concrete_ProlsUserService()
    {
        return $this->services['security.user.provider.concrete.prols_user'] = new \Symfony\Bridge\Propel1\Security\User\PropelUserProvider('CoreBundle\\Model\\EmpAcc', 'username');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_port' => NULL,
            'locale' => 'en',
            'secret' => '65d05243b2553594b4809b4ed5e75bda13de3d24',
            ...
            'kernel.secret' => '65d05243b2553594b4809b4ed5e75bda13de3d24',
            ...
            'swiftmailer.mailer.dev_mailer.transport.name' => 'smtp',
            'swiftmailer.mailer.dev_mailer.delivery.enabled' => true,
            'swiftmailer.mailer.dev_mailer.transport.smtp.encryption' => NULL,
            'swiftmailer.mailer.dev_mailer.transport.smtp.port' => 25,
            'swiftmailer.mailer.dev_mailer.transport.smtp.host' => '127.0.0.1',
            'swiftmailer.mailer.dev_mailer.transport.smtp.username' => NULL,
            'swiftmailer.mailer.dev_mailer.transport.smtp.password' => NULL,
            'swiftmailer.mailer.dev_mailer.transport.smtp.auth_mode' => NULL,
            'swiftmailer.mailer.dev_mailer.transport.smtp.timeout' => 30,
            'swiftmailer.mailer.dev_mailer.transport.smtp.source_ip' => NULL,
            'swiftmailer.mailer.dev_mailer.spool.enabled' => false,
            'swiftmailer.mailer.dev_mailer.plugin.impersonate' => NULL,
            'swiftmailer.mailer.dev_mailer.single_address' => NULL,
            'swiftmailer.spool.enabled' => false,
            'swiftmailer.delivery.enabled' => true,
            'swiftmailer.single_address' => NULL,
            'swiftmailer.mailers' => array(
                'dev_mailer' => 'swiftmailer.mailer.dev_mailer',
            ),
            'swiftmailer.default_mailer' => 'dev_mailer',
            ...
            'propel.logging' => true,
            'propel.dbal.default_connection' => 'prols',
