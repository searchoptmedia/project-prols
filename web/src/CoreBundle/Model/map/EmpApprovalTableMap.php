 ...
 */
class EmpApprovalTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.CoreBundle.Model.map.EmpApprovalTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('EmpApproval');
        $this->setClassname('CoreBundle\\Model\\EmpApproval');
        ...
        $this->addForeignKey('emp_time_id', 'EmpTimeId', 'INTEGER', 'emp_time', 'id', true, null, null);
        // validators
    } // initialize()
