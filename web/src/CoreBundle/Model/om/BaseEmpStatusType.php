...
abstract class BaseEmpStatusType extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CoreBundle\\Model\\EmpStatusTypePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        EmpStatusTypePeer
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = EmpStatusTypePeer::ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = EmpStatusTypePeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = EmpStatusTypePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating EmpStatusType object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = EmpStatusTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = EmpStatusTypeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EmpStatusTypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(EmpStatusTypePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(EmpStatusTypePeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }

        $sql = sprintf(
            'INSERT INTO `emp_status_type` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = EmpStatusTypePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = EmpStatusTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['EmpStatusType'][$this->getPrimaryKey()] = true;
        $keys = EmpStatusTypePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        );
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EmpStatusTypePeer::ID)) $criteria->add(EmpStatusTypePeer::ID, $this->id);
        if ($this->isColumnModified(EmpStatusTypePeer::NAME)) $criteria->add(EmpStatusTypePeer::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(EmpStatusTypePeer::DATABASE_NAME);
        $criteria->add(EmpStatusTypePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of EmpStatusType (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return EmpStatusType Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return EmpStatusTypePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new EmpStatusTypePeer();
        }
    ...
    {
        return (string) $this->exportTo(EmpStatusTypePeer::DEFAULT_STRING_FORMAT);
    }
