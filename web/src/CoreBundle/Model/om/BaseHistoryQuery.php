 ...
 * @method HistoryQuery orderByModule($order = Criteria::ASC) Order by the module column
 * @method HistoryQuery orderByAction($order = Criteria::ASC) Order by the action column
 *
 * @method HistoryQuery groupById() Group by the id column
 * @method HistoryQuery groupByModule() Group by the module column
 * @method HistoryQuery groupByAction() Group by the action column
 *
 ...
 *
 * @method HistoryQuery leftJoinEventTagHistory($relationAlias = null) Adds a LEFT JOIN clause to the query using the EventTagHistory relation
 * @method HistoryQuery rightJoinEventTagHistory($relationAlias = null) Adds a RIGHT JOIN clause to the query using the EventTagHistory relation
 * @method HistoryQuery innerJoinEventTagHistory($relationAlias = null) Adds a INNER JOIN clause to the query using the EventTagHistory relation
 *
 ...
 *
 * @method History findOneByModule(string $module) Return the first History filtered by the module column
 * @method History findOneByAction(string $action) Return the first History filtered by the action column
 *
 * @method array findById(int $id) Return History objects filtered by the id column
 * @method array findByModule(string $module) Return History objects filtered by the module column
 * @method array findByAction(string $action) Return History objects filtered by the action column
 */
abstract class BaseHistoryQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'CoreBundle\\Model\\History';
        }
    ...
    {
        $sql = 'SELECT `id`, `module`, `action` FROM `history` WHERE `id` = :p0';
        try {
    ...
    public function filterByModule($module = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(HistoryPeer::MODULE, $module, $comparison);
    }
    ...
    public function filterByAction($action = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(HistoryPeer::ACTION, $action, $comparison);
    }
    ...
    public function filterByEventTagHistory($eventTagHistory, $comparison = null)
    {
        if ($eventTagHistory instanceof EventTagHistory) {
            return $this
                ->addUsingAlias(HistoryPeer::ID, $eventTagHistory->getHistoryId(), $comparison);
