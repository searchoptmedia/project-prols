...
abstract class BaseListContTypes extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CoreBundle\\Model\\ListContTypesPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ListContTypesPeer
     */
     ...
     * @return ListContTypes The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = ListContTypesPeer::ID;
        }
    ...
    public function setContactType($v)
    {
        ...
        if ($this->contact_type !== $v) {
            $this->contact_type = $v;
            $this->modifiedColumns[] = ListContTypesPeer::CONTACT_TYPE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->contact_type = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = ListContTypesPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ListContTypes object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ListContTypesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ListContTypesQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ListContTypesPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ListContTypesPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ListContTypesPeer::CONTACT_TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`contact_type`';
        }

        $sql = sprintf(
            'INSERT INTO `list_cont_types` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ListContTypesPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ListContTypesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ListContTypes'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ListContTypes'][$this->getPrimaryKey()] = true;
        $keys = ListContTypesPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ListContTypesPeer::ID)) $criteria->add(ListContTypesPeer::ID, $this->id);
        if ($this->isColumnModified(ListContTypesPeer::CONTACT_TYPE)) $criteria->add(ListContTypesPeer::CONTACT_TYPE, $this->contact_type);
    ...
    {
        $criteria = new Criteria(ListContTypesPeer::DATABASE_NAME);
        $criteria->add(ListContTypesPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of ListContTypes (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ListContTypes Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ListContTypesPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ListContTypesPeer();
        }
     ...
     * If this ListContTypes is new, it will return
    ...
    public function setEmpContacts(PropelCollection $empContacts, PropelPDO $con = null)
    {
        ...
        foreach ($empContactsToDelete as $empContactRemoved) {
            $empContactRemoved->setListContTypes(null);
        }
    ...
    protected function doAddEmpContact($empContact)
    {
        ...
        $empContact->setListContTypes($this);
    }
    ...
    public function removeEmpContact($empContact)
    {
        if ($this->getEmpContacts()->contains($empContact)) {
            ...
            $empContact->setListContTypes(null);
        }
     ...
     * Otherwise if this ListContTypes is new, it will return
     * an empty collection; or if this ListContTypes has previously
     * been saved, it will retrieve related EmpContacts from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in ListContTypes.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|EmpContact[] List of EmpContact objects
     */
    public function getEmpContactsJoinEmpProfile($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = EmpContactQuery::create(null, $criteria);
        $query->joinWith('EmpProfile', $join_behavior);
    ...
    {
        return (string) $this->exportTo(ListContTypesPeer::DEFAULT_STRING_FORMAT);
    }
