 ...
 * @method ListEvents findOneByType(string $type) Return the first ListEvents filtered by the type column
 *
 ...
 * @method array findByType(string $type) Return ListEvents objects filtered by the type column
 */
