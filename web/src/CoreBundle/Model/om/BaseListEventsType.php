...
abstract class BaseListEventsType extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CoreBundle\\Model\\ListEventsTypePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ListEventsTypePeer
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = ListEventsTypePeer::ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ListEventsTypePeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = ListEventsTypePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ListEventsType object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ListEventsTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ListEventsTypeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ListEventsTypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ListEventsTypePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ListEventsTypePeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }

        $sql = sprintf(
            'INSERT INTO `list_events_type` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ListEventsTypePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ListEventsTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ListEventsType'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ListEventsType'][$this->getPrimaryKey()] = true;
        $keys = ListEventsTypePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        );
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ListEventsTypePeer::ID)) $criteria->add(ListEventsTypePeer::ID, $this->id);
        if ($this->isColumnModified(ListEventsTypePeer::NAME)) $criteria->add(ListEventsTypePeer::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(ListEventsTypePeer::DATABASE_NAME);
        $criteria->add(ListEventsTypePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of ListEventsType (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ListEventsType Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ListEventsTypePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ListEventsTypePeer();
        }
     ...
     * If this ListEventsType is new, it will return
    ...
    public function setListEventss(PropelCollection $listEventss, PropelPDO $con = null)
    {
        ...
        foreach ($listEventssToDelete as $listEventsRemoved) {
            $listEventsRemoved->setListEventsType(null);
        }
    ...
    protected function doAddListEvents($listEvents)
    {
        ...
        $listEvents->setListEventsType($this);
    }
    ...
    public function removeListEvents($listEvents)
    {
        if ($this->getListEventss()->contains($listEvents)) {
            ...
            $listEvents->setListEventsType(null);
        }
    ...
    {
        return (string) $this->exportTo(ListEventsTypePeer::DEFAULT_STRING_FORMAT);
    }
