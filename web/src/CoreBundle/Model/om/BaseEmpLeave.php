...
abstract class BaseEmpLeave extends BaseObject implements Persistent
{
    ...
    public function setAdminId($v)
    {
        ...
        if ($this->admin_id !== $v) {
            $this->admin_id = $v;
            $this->modifiedColumns[] = EmpLeavePeer::ADMIN_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 8; // 8 = EmpLeavePeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(EmpLeavePeer::ADMIN_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EmpLeavePeer::ADMIN_ID)) $criteria->add(EmpLeavePeer::ADMIN_ID, $this->admin_id);
    ...
    public function setEmpAccRelatedByEmpAccId(EmpAcc $v = null)
    {
        ...
        if ($v !== null) {
            $v->addEmpLeaveRelatedByEmpAccId($this);
        }
    ...
    public function getEmpAccRelatedByEmpAccId(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aEmpAccRelatedByEmpAccId === null && ($this->emp_acc_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aEmpAccRelatedByEmpAccId->addEmpLeavesRelatedByEmpAccId($this);
             */
        }
    ...
    public function setEmpAccRelatedByAdminId(EmpAcc $v = null)
    {
        ...
        // If this object has already been added to the EmpAcc object, it will not be re-added.
        if ($v !== null) {
            $v->addEmpLeaveRelatedByAdminId($this);
        }
    ...
    public function getEmpAccRelatedByAdminId(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aEmpAccRelatedByAdminId === null && ($this->admin_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aEmpAccRelatedByAdminId->addEmpLeavesRelatedByAdminId($this);
             */
        }
