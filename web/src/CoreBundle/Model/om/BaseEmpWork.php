...
abstract class BaseEmpWork extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CoreBundle\\Model\\EmpWorkPeer';
    ...
    /**
     * The value for the list_dept_dept_id field.
     * @var        int
     */
    protected $list_dept_dept_id;

    /**
     * The value for the list_pos_pos_id field.
     * @var        int
     */
    protected $list_pos_pos_id;
    ...
    /**
     * Get the [list_dept_dept_id] column value.
     *
     * @return int
     */
    public function getListDeptDeptId()
    {
        ...
        return $this->list_dept_dept_id;
    }

    /**
     * Get the [list_pos_pos_id] column value.
     *
     * @return int
     */
     ...
     * @return EmpWork The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = EmpWorkPeer::ID;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[] = EmpWorkPeer::STATUS;
        }
    ...
    /**
     * Set the value of [list_dept_dept_id] column.
     *
     * @param  int $v new value
     * @return EmpWork The current object (for fluent API support)
     */
    public function setListDeptDeptId($v)
    {
        ...
        if ($this->list_dept_dept_id !== $v) {
            $this->list_dept_dept_id = $v;
            $this->modifiedColumns[] = EmpWorkPeer::LIST_DEPT_DEPT_ID;
        }
    ...
    /**
     * Set the value of [list_pos_pos_id] column.
     *
     * @param  int $v new value
     * @return EmpWork The current object (for fluent API support)
     */
    public function setListPosPosId($v)
    {
        ...
        if ($this->list_pos_pos_id !== $v) {
            $this->list_pos_pos_id = $v;
            $this->modifiedColumns[] = EmpWorkPeer::LIST_POS_POS_ID;
        }
    ...
    public function setEmpAccAccId($v)
    {
        ...
        if ($this->emp_acc_acc_id !== $v) {
            ...
            $this->modifiedColumns[] = EmpWorkPeer::EMP_ACC_ACC_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->list_dept_dept_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->list_pos_pos_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->emp_acc_acc_id = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
            $this->resetModified();
            ...
            return $startcol + 5; // 5 = EmpWorkPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating EmpWork object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aListDept !== null && $this->list_dept_dept_id !== $this->aListDept->getId()) {
            $this->aListDept = null;
        }
        if ($this->aListPos !== null && $this->list_pos_pos_id !== $this->aListPos->getId()) {
            $this->aListPos = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = EmpWorkPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = EmpWorkQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EmpWorkPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(EmpWorkPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(EmpWorkPeer::STATUS)) {
            $modifiedColumns[':p' . $index++]  = '`status`';
        }
        if ($this->isColumnModified(EmpWorkPeer::LIST_DEPT_DEPT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`list_dept_dept_id`';
        }
        if ($this->isColumnModified(EmpWorkPeer::LIST_POS_POS_ID)) {
            $modifiedColumns[':p' . $index++]  = '`list_pos_pos_id`';
        }
        if ($this->isColumnModified(EmpWorkPeer::EMP_ACC_ACC_ID)) {
            $modifiedColumns[':p' . $index++]  = '`emp_acc_acc_id`';
        }

        $sql = sprintf(
            'INSERT INTO `emp_work` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`status`':
                        ...
                        break;
                    case '`list_dept_dept_id`':
                        $stmt->bindValue($identifier, $this->list_dept_dept_id, PDO::PARAM_INT);
                        break;
                    case '`list_pos_pos_id`':
                        $stmt->bindValue($identifier, $this->list_pos_pos_id, PDO::PARAM_INT);
                        break;
                    case '`emp_acc_acc_id`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = EmpWorkPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = EmpWorkPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['EmpWork'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['EmpWork'][$this->getPrimaryKey()] = true;
        $keys = EmpWorkPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getStatus(),
            $keys[2] => $this->getListDeptDeptId(),
            $keys[3] => $this->getListPosPosId(),
            $keys[4] => $this->getEmpAccAccId(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setListDeptDeptId($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setListPosPosId($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setEmpAccAccId($arr[$keys[4]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EmpWorkPeer::ID)) $criteria->add(EmpWorkPeer::ID, $this->id);
        if ($this->isColumnModified(EmpWorkPeer::STATUS)) $criteria->add(EmpWorkPeer::STATUS, $this->status);
        if ($this->isColumnModified(EmpWorkPeer::LIST_DEPT_DEPT_ID)) $criteria->add(EmpWorkPeer::LIST_DEPT_DEPT_ID, $this->list_dept_dept_id);
        if ($this->isColumnModified(EmpWorkPeer::LIST_POS_POS_ID)) $criteria->add(EmpWorkPeer::LIST_POS_POS_ID, $this->list_pos_pos_id);
        if ($this->isColumnModified(EmpWorkPeer::EMP_ACC_ACC_ID)) $criteria->add(EmpWorkPeer::EMP_ACC_ACC_ID, $this->emp_acc_acc_id);
    ...
    {
        $criteria = new Criteria(EmpWorkPeer::DATABASE_NAME);
        $criteria->add(EmpWorkPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of EmpWork (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return EmpWork Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($this->aListDept === null && ($this->list_dept_dept_id !== null) && $doQuery) {
            $this->aListDept = ListDeptQuery::create()->findPk($this->list_dept_dept_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aListDept->addEmpWorks($this);
             */
        }
    ...
    {
        if ($this->aListPos === null && ($this->list_pos_pos_id !== null) && $doQuery) {
            $this->aListPos = ListPosQuery::create()->findPk($this->list_pos_pos_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aListPos->addEmpWorks($this);
             */
        }
    ...
    public function clear()
    {
        $this->id = null;
        $this->status = null;
        $this->list_dept_dept_id = null;
        $this->list_pos_pos_id = null;
    ...
    {
        return (string) $this->exportTo(EmpWorkPeer::DEFAULT_STRING_FORMAT);
    }
