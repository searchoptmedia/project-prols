...
abstract class BaseListEventsPeer
{
    ...
    const DATE = 'list_events.date';

    /** the column name for the name field */
    const NAME = 'list_events.name';

    /** the column name for the desc field */
    const DESC = 'list_events.desc';

    /** the column name for the type field */
    const TYPE = 'list_events.type';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Date', 'Name', 'Description', 'Type', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'date', 'name', 'description', 'type', ),
        BasePeer::TYPE_COLNAME => array (ListEventsPeer::ID, ListEventsPeer::DATE, ListEventsPeer::NAME, ListEventsPeer::DESC, ListEventsPeer::TYPE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'DATE', 'NAME', 'DESC', 'TYPE', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'date', 'name', 'desc', 'type', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Date' => 1, 'Name' => 2, 'Description' => 3, 'Type' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'date' => 1, 'name' => 2, 'description' => 3, 'type' => 4, ),
        BasePeer::TYPE_COLNAME => array (ListEventsPeer::ID => 0, ListEventsPeer::DATE => 1, ListEventsPeer::NAME => 2, ListEventsPeer::DESC => 3, ListEventsPeer::TYPE => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'DATE' => 1, 'NAME' => 2, 'DESC' => 3, 'TYPE' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'date' => 1, 'name' => 2, 'desc' => 3, 'type' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ListEventsPeer::DATE);
            $criteria->addSelectColumn(ListEventsPeer::NAME);
            $criteria->addSelectColumn(ListEventsPeer::DESC);
            $criteria->addSelectColumn(ListEventsPeer::TYPE);
        } else {
    ...
    public static function doCountJoinListEventsType(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(ListEventsPeer::TYPE, ListEventsTypePeer::ID, $join_behavior);
