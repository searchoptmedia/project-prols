...
abstract class BaseEventTaggedPersons extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CoreBundle\\Model\\EventTaggedPersonsPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        EventTaggedPersonsPeer
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = EventTaggedPersonsPeer::ID;
        }
    ...
    public function setEventId($v)
    {
        ...
        if ($this->event_id !== $v) {
            $this->event_id = $v;
            $this->modifiedColumns[] = EventTaggedPersonsPeer::EVENT_ID;
        }
    ...
    public function setEmpId($v)
    {
        ...
        if ($this->emp_id !== $v) {
            $this->emp_id = $v;
            $this->modifiedColumns[] = EventTaggedPersonsPeer::EMP_ID;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[] = EventTaggedPersonsPeer::STATUS;
        }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aEmpAcc !== null && $this->emp_id !== $this->aEmpAcc->getId()) {
            $this->aEmpAcc = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = EventTaggedPersonsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = EventTaggedPersonsQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EventTaggedPersonsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(EventTaggedPersonsPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(EventTaggedPersonsPeer::EVENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`event_id`';
        }
        if ($this->isColumnModified(EventTaggedPersonsPeer::EMP_ID)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = EventTaggedPersonsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = EventTaggedPersonsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['EventTaggedPersons'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['EventTaggedPersons'][$this->getPrimaryKey()] = true;
        $keys = EventTaggedPersonsPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EventTaggedPersonsPeer::ID)) $criteria->add(EventTaggedPersonsPeer::ID, $this->id);
    ...
    {
        $criteria = new Criteria(EventTaggedPersonsPeer::DATABASE_NAME);
        $criteria->add(EventTaggedPersonsPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of EventTaggedPersons (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return EventTaggedPersons Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return EventTaggedPersonsPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new EventTaggedPersonsPeer();
        }
    ...
    {
        if ($this->aEmpAcc === null && ($this->emp_id !== null) && $doQuery) {
            $this->aEmpAcc = EmpAccQuery::create()->findPk($this->emp_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aEmpAcc->addEventTaggedPersonss($this);
             */
        }
    ...
    public function getListEvents(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aListEvents === null && ($this->event_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aListEvents->addEventTaggedPersonss($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(EventTaggedPersonsPeer::DEFAULT_STRING_FORMAT);
    }
