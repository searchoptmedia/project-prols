            ...
            if($("#calendar").length > 0){
                ...
                var calendar = $('#calendar').fullCalendar({
                   ...
                   $('.btn-submitmeeting').off('click').click(function(e){
                        e.preventDefault();
                       var calendarMeeting = $('#meeting').val();
                       ...
                       console.log(calendarMeeting);

                       if (calendarMeeting) {
                           calendar.fullCalendar('renderEvent',
                           {
                               title: calendarMeeting,
                               start: start,
                               end: end,
                               allDay: allDay,
                    ...
                    $('.btn-submitleave').off('click').click(function(e){
                        e.preventDefault();
                       var calendarLeave = $('#reason-leave').val();
